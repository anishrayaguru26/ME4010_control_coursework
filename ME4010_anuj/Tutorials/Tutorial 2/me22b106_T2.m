...
G_d_sym = s^2 * (s + 5) * (s + 15); G_n_sym = 1; %explanation for why it is s^2 and not 1 is given in pdf
...
pole_comp
rlocus(tf(sym2poly(G_n_sym * (s - zero_comp)),sym2poly(G_d_sym * (s - pole_comp)))); hold on; plot(r1, 'rx');
